...
class FileLoader:
    ...
    def _retrieve_localdir_from_syncfile(self):
        ...
        try:
            ...
            FROM sync_file WHERE processed = 1 and modified_date >= '2025-02-01' --AND facility_id IN (SELECT datim_id FROM central_partner_mapping WHERE is_run)
            AND (decrypted_file_name ilike 'prep_eligibility_%' or decrypted_file_name ilike 'mhpss_confirmation_%'
